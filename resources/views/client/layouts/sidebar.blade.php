    ...
    <div class="side-bar p-sm-4 p-3">
        <div class="search-hotel border-bottom py-2">
            ...
            <form action="{{ route('search') }}" method="get">
                <input type="search" placeholder="Tên sản phẩm..." name="q" required="">
            ...
            <div class="box-scroll">
                <div class="scroll">
                    @foreach ($product as $item)
                        <div class="row">
                            <div class="col-lg-6 col-sm-2 col-3 left-mar">
                            <img src="img/upload/product/{{$item->image}}" alt="" class="img-fluid">
                            </div>
                            <div class="col-lg-6 col-sm-10 col-9 w3_mvd">
                                <a href="">{{$item->name}}</a>
                                <a href="" class="price-mar mt-2">{{$item->price}} VNĐ</a>
                            </div>
                        </div>
                    @endforeach
