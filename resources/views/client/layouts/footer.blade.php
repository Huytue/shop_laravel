	...
	<div class="footer-top-first">
		<div class="container py-md-5 py-sm-4 py-3">
			...
			<p class="footer-main mb-4">
				Nếu bạn đang xem xét một máy tính xách tay mới, tìm kiếm một âm thanh nổi xe hơi mới mạnh mẽ hoặc mua một HDTV mới, chúng tôi giúp bạn dễ dàng tìm thấy chính xác những gì bạn cần với mức giá bạn có thể chi trả. Chúng tôi cung cấp Giá thấp mỗi ngày trên TV, máy tính xách tay, điện thoại di động, máy tính bảng và iPad, trò chơi video, máy tính để bàn, máy ảnh và máy quay phim, âm thanh, video và nhiều hơn nữa.</p>
			<!-- //footer first section -->
...
<script type="text/javascript">
	...
	s1.async=true;
	s1.src='https://embed.tawk.to/5df44ba8d96992700fcc3b2c/default';
	s1.charset='UTF-8';
