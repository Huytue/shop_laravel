			...
			<div class="col-md-3 logo_agile">
				<h1 class="text-center">
					<a href="{{ route('home') }}" class="font-weight-bold font-italic">
						<img src="assets/client/images/logo2.png" alt=" " class="img-responsive">Shop Công Nghệ
					</a>
				</h1>
			</div>
			<!-- //logo -->
				...
				<div class="row">
					...
					<div class="col-10 agileits_search">
						<form class="form-inline" action="{{ route('search') }}" method="get">
							<input class="form-control mr-sm-2" type="search" name="q" placeholder="Nhập tên sản phẩm cần tìm" aria-label="Search" required>
